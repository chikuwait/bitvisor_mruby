...
#define TYPED_FLOAT_POSFIXABLE(f) (f64_le(f,i64_to_f64(MRB_INT_MAX)))
#define TYPED_FLOAT_NEGFIXABLE(f) (f64_le(i64_to_f64(MRB_INT_MIN),f))
#define TYPED_FLOAT_FIXABLE(f) (TYPED_FLOAT_POSFIXABLE(f) && TYPED_FLOAT_NEGFIXABLE(f))
#define FIXABLE_FLOAT(f) TYPED_FLOAT_FIXABLE(f)
#endif
